...
public class GeoshapeTest {
    ...
    public void testIntersection() {
        for (int i = 0; i < 50; i++) {
            ...
            Geoshape line = Geoshape
                .line(Arrays.asList(new double[][]{{i - 1, i - 1}, {i, i}, {i + 1, i + 1}}));
            Geoshape polygon = Geoshape.polygon(Arrays.asList(
                new double[][]{{i - 1, i - 1}, {i, i - 1}, {i + 1, i - i}, {i + 1, i + 1},
                    {i - 1, i + 1}, {i - 1, i - 1}}));
            Geoshape circle = Geoshape
                .circle(i, i, point.getPoint().distance(Geoshape.point(i, i).getPoint()) + 10);
    ...
    public void testEquality() {
        ...
        Geoshape l = Geoshape
            .line(Arrays.asList(new double[][]{{10.5, 20.5}, {10.5, 22.5}, {12.5, 22.5}}));
        Geoshape p = Geoshape.polygon(Arrays.asList(
            new double[][]{{10.5, 20.5}, {8.0, 21.75}, {10.5, 22.5}, {11.75, 25.0}, {12.5, 22.5},
                {15.0, 21.0}, {12.5, 20.5}, {11.75, 18.0}, {10.5, 20.5}}));
        assertEquals(Geoshape.circle(10.0, 12.5, 100), c);
        assertEquals(Geoshape.box(20.0, 22.5, 40.5, 60.5), b);
        assertEquals(
            Geoshape.line(Arrays.asList(new double[][]{{10.5, 20.5}, {10.5, 22.5}, {12.5, 22.5}})),
            l);
        assertEquals(Geoshape.polygon(Arrays.asList(
            new double[][]{{10.5, 20.5}, {8.0, 21.75}, {10.5, 22.5}, {11.75, 25.0}, {12.5, 22.5},
                {15.0, 21.0}, {12.5, 20.5}, {11.75, 18.0}, {10.5, 20.5}})), p);
        ...
        assertEquals(Geoshape.polygon(Arrays.asList(
            new double[][]{{10.5, 20.5}, {8.0, 21.75}, {10.5, 22.5}, {11.75, 25.0}, {12.5, 22.5},
                {15.0, 21.0}, {12.5, 20.5}, {11.75, 18.0}, {10.5, 20.5}})).hashCode(),
            p.hashCode());
    ...
    public void testParseCollection() {
        ...
        assertEquals(Geoshape.box(10, 20, 30, 40),
            serializer.convert(Arrays.asList(10, 20, 30, 40)));
    }
    ...
    public void testGeoJsonLine() throws IOException {
        ...
        Map json = new ObjectMapper().readValue("{\n" +
            ...
            "}", HashMap.class);
        assertEquals(
            Geoshape.line(Arrays.asList(new double[][]{{20.5, 10.5}, {22.5, 10.5}, {22.5, 12.5}})),
            s.convert(json));
    }
    ...
    public void testGeoJsonPolygon() throws IOException {
        ...
        Map json = new ObjectMapper().readValue("{\n" +
            ...
            "}", HashMap.class);
        assertEquals(Geoshape.polygon(Arrays.asList(
            new double[][]{{20.5, 10.5}, {21.75, 8.0}, {22.5, 10.5}, {25.0, 11.75}, {22.5, 12.5},
                {21.0, 15.0}, {20.5, 12.5}, {18.0, 11.75}, {20.5, 10.5}})), s.convert(json));
    }
    ...
    public void testGeoJsonMultiPoint() throws IOException {
        ...
        assertEquals(HELPER.geoshape(
            GF.createMultiPoint(new Coordinate[]{new Coordinate(100, 0), new Coordinate(101, 1)})),
            s.convert(json));
    }
    ...
    public void testGeoJsonMultiLineString() throws IOException {
        ...
        assertEquals(HELPER.geoshape(GF.createMultiLineString(new LineString[]{
                ...
                GF.createLineString(
                    new Coordinate[]{new Coordinate(102, 2), new Coordinate(103, 3)})})),
            s.convert(json));
    }
    ...
    public void testGeoJsonMultiPolygon() throws IOException {
        ...
        assertEquals(HELPER.geoshape(GF.createMultiPolygon(new Polygon[]{
            GF.createPolygon(new Coordinate[]{new Coordinate(102, 2), new Coordinate(103, 2),
                new Coordinate(103, 3), new Coordinate(102, 3), new Coordinate(102, 2)}),
            GF.createPolygon(GF.createLinearRing(
                new Coordinate[]{new Coordinate(100, 0), new Coordinate(101, 0),
                    new Coordinate(101, 1), new Coordinate(100, 1), new Coordinate(100, 0)}),
                new LinearRing[]{GF.createLinearRing(
                    new Coordinate[]{new Coordinate(100.2, 0.2), new Coordinate(100.8, 0.2),
    ...
    public void testGeoJsonSerialization() throws IOException {
        ...
        assertEquals(
            "{\"type\":\"Polygon\",\"coordinates\": [[[20.5,10.5],[20.5,12.5],[22.5,12.5],[22.5,10.5],[20.5,10.5]]]}",
            om.writeValueAsString(Geoshape.box(10.5, 20.5, 12.5, 22.5)));
        assertEquals(
            "{\"type\":\"Circle\",\"coordinates\":[20.5,10.5],\"radius\":30.5,\"properties\":{\"radius_units\":\"km\"}}",
            om.writeValueAsString(Geoshape.circle(10.5, 20.5, 30.5)));
        assertEquals(
            "{\"type\":\"LineString\",\"coordinates\":[[20.5,10.5],[22.5,10.5],[22.5,12.5]]}",
            om.writeValueAsString(Geoshape
                .line(Arrays.asList(new double[][]{{20.5, 10.5}, {22.5, 10.5}, {22.5, 12.5}}))));
        assertEquals(
            "{\"type\":\"Polygon\",\"coordinates\":[[[20.5,10.5],[21.75,8],[22.5,10.5],[25,11.75],[22.5,12.5],[21,15],[20.5,12.5],[18,11.75],[20.5,10.5]]]}",
            om.writeValueAsString(Geoshape.polygon(Arrays.asList(
                new double[][]{{20.5, 10.5}, {21.75, 8}, {22.5, 10.5}, {25, 11.75}, {22.5, 12.5},
                    {21, 15}, {20.5, 12.5}, {18, 11.75}, {20.5, 10.5}}))));
        assertEquals("{\"type\":\"MultiPoint\",\"coordinates\":[[100,0],[101,1]]}",
            om.writeValueAsString(Geoshape.geoshape(context.makeShape(GF.createMultiPoint(
                new Coordinate[]{new Coordinate(100, 0), new Coordinate(101, 1)})))));
        assertEquals(
            "{\"type\":\"MultiLineString\",\"coordinates\":[[[100,0],[101,1]],[[102,2],[103,3]]]}",
            om.writeValueAsString(
                Geoshape.geoshape(context.makeShape(GF.createMultiLineString(new LineString[]{
                    GF.createLineString(
                        new Coordinate[]{new Coordinate(100, 0), new Coordinate(101, 1)}),
                    GF.createLineString(
                        new Coordinate[]{new Coordinate(102, 2), new Coordinate(103, 3)})})))));
        assertEquals(
            ...
            om.writeValueAsString(
                Geoshape.geoshape(context.makeShape(GF.createMultiPolygon(new Polygon[]{
                    GF.createPolygon(
                        new Coordinate[]{new Coordinate(102, 2), new Coordinate(103, 2),
                            new Coordinate(103, 3), new Coordinate(102, 3),
                            new Coordinate(102, 2)}),
                    GF.createPolygon(GF.createLinearRing(
                        new Coordinate[]{new Coordinate(100, 0), new Coordinate(101, 0),
                            new Coordinate(101, 1), new Coordinate(100, 1),
